...
import GenericProductDetail from './pages/GenericProductDetail.jsx'
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/product/:productId" element={<CustomerLayout><GenericProductDetail /></CustomerLayout>} />
