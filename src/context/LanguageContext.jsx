...
const TRANSLATIONS = {
  EN: {
    ...
    heroDesc: 'Elevate your presence. Experience the intersection of minimalist design and uncompromising cinematic quality.',
    ...
    artOfStyle: 'The Art of Modern Style',
    manifestoDesc: 'We define luxury through restraint. Our silhouettes are crafted not just to be worn, but to inhabit the space around them with silent authority.',
