...
# Design System Data
design_system_guidelines = """## Brand & Style
...
with open("design_system/style_guidelines.md", "w", encoding="utf-8") as f:
    f.write(design_system_guidelines)

with open("design_system/design_system.md", "w", encoding="utf-8") as f:
    f.write(design_system_md)

with open("design_system/theme.json", "w", encoding="utf-8") as f:
    json.dump(theme_json, f, indent=2)

print("Saved design system files.")

# List of screens to download
downloads = [
    # 1. A_realistic,_artistic_shot_of_202606281229.jpeg
    {
        "type": "image",
    ...
    # 2. DESIGN.md (ID: 17583233910020018559)
    {
        "type": "code",
    ...
    # 3. DESIGN.md (ID: 17583233910020018677)
    {
        "type": "code",
    ...
    # 7. NOIR LUXE — Obsidian Tote Detail
    {
        "type": "image",
    ...
    # 8. NOIR LUXE — Obsidian Tote Premium Experience
    {
        "type": "image",
    ...
    # 9. NOIR LUXE — Secure Checkout (PayPal)
    {
        "type": "image",
    ...
    # 10. NOIR LUXE — Membership Registration
    {
        "type": "image",
    ...
    # 12. NOIR LUXE — Admin Order Detail View
    {
        "type": "image",
    ...
    # 13. NOIR LUXE — Admin Order Management
    {
        "type": "image",
    ...
    # 14. image.png_202606291607.jpeg
    {
        "type": "image",
    ...
    # 15. High-end luxury fashion editorial photography...
    {
        "type": "image",
